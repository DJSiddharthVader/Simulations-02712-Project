...
In order to experiment and observe how QS interactions affect population structure we first needed to obtain a representative model for a multi strain QS system.
